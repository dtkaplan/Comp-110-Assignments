...
# a) summary
# b) neither - this makes a pair of values
# c) summary
# d) transformation
# e) transformation
# f) summary
...
# 1) ABCD
# 2) 2
# 3) 1 doesn't show the edge between c and d, and shows there's an edge between b and c which is false. 2 has a third column, which doesn't make sense
