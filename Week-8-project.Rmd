...
And that is it!  Unfortunately, I seam to have lost the name information from the variable names in `clusterReadyProbes`.  I am not familiar enough with the methodology to track down where I lost these names.  
