...
(a) The wrong character is used.  ` should be used rather than '. 
(b) Once again, the wrong character is used.  ` should be used rather than "
(c) This is better, but three clossing quotes sould be used rather than two. 
...
(1) This could be both
(2) This can only be a URL.  This cannot be a file naem because of the / character. 
(3) 
